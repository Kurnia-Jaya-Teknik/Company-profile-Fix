        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-midnight_text dark:text-white mb-4">
              Karir di CV. Kurnia Jaya Teknik
            </h2>
          ...
          <div className="bg-white dark:bg-darkmode rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                <h4 className="text-xl font-semibold text-midnight_text dark:text-white mb-2">
                  Teknisi Elektrikal
                </h4>
                <p className="text-body-color dark:text-gray-300 mb-2">
                  Mencari teknisi berpengalaman dalam instalasi dan maintenance sistem elektrikal.
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <h4 className="text-xl font-semibold text-midnight_text dark:text-white mb-2">
                ...
                <p className="text-body-color dark:text-gray-300 mb-2">
                  Mencari teknisi berpengalaman dalam instalasi dan maintenance sistem mekanikal.
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <h4 className="text-xl font-semibold text-midnight_text dark:text-white mb-2">
                ...
                <p className="text-body-color dark:text-gray-300 mb-2">
                  Mencari programmer berpengalaman dalam pemrograman PLC, HMI, dan SCADA.
                </p>
              </div>
            </div>
          </div>

          <div className="bg-white dark:bg-darkmode rounded-lg shadow-lg p-8">
            <h3 className="text-2xl font-semibold text-midnight_text dark:text-white mb-6">
              Cara Melamar
            </h3>
            <p className="text-body-color dark:text-gray-300 mb-4">
            ...
            <div className="space-y-2 text-body-color dark:text-gray-300">
              <p><strong>Email:</strong> info@kurniajayateknik.com</p>
              <p><strong>Atau hubungi kami</strong> melalui halaman <a href="/contact" className="text-primary hover:underline">Hubungi Kami</a></p>
            </div>
          </div>
        </div>
      </div>
